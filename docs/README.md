...
These documents define what Friday should honestly claim today:
...
- [macOS Auto-Start](ops/friday-autostart-macos.md)
- [Local Runtime Troubleshooting](ops/friday-agent-os-troubleshooting.md)
- [Cross-Platform Downloads](ops/friday-cross-platform-downloads.md)
...
- [Skill Generator Design](skill-generator-design.md)
...
Long-lived technical reference material lives under [reference/](reference/):
