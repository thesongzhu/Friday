...
Generated at: 2026-03-08T22:01:22.128Z
...
| --- | --- | --- | --- |
| dialog-missing-info-backup | dialog | Equivalent | Both systems completed the case with similar automatic scores. |
| dialog-ambiguous-goal-noise | dialog | Equivalent | Both systems completed the case with similar automatic scores. |
| dialog-risk-boundary-reset | dialog | Equivalent | Both systems completed the case with similar automatic scores. |
| dialog-expectation-boundary-autonomy | dialog | Gap | OpenClaw succeeded while Friday did not. |
