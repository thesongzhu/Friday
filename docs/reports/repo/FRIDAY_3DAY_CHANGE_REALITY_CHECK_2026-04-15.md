# Friday 3-Day Change Reality Check (2026-04-15)
...
| search-latestness | 搜索 | 当前 runtime 的 search freshness 已经被真实验证。 | not proven | /v1/health capabilities.search.latestness=unverified. | Live /v1/health capability snapshot. |
