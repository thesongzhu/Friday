...
mod tests {
    ...
    fn work_item(id: &str, mission_id: &str) -> WorkItem {
        WorkItem {
            ...
            workspace_refs: vec!["/Users/example/private/friday".into()],
            capability_id: Some("global.work_graph".into()),
            risk_level: Risk::Medium,
            approval_state: ApprovalState::NotRequired,
            blocking_reason: None,
            input_refs: vec!["/Users/example/private/raw-input".into()],
            output_refs: Vec::new(),
    ...
    fn active_claim() -> WorkspaceClaim {
        WorkspaceClaim {
            ...
            workspace_ref: "/Users/example/private/friday".into(),
    ...
    fn running_lease() -> ProcessLease {
        ProcessLease {
            ...
            cwd_ref: "/Users/example/private/friday".into(),
    ...
    fn unowned_observation() -> ProcessObservation {
        ProcessObservation {
            ...
            cwd_ref: "/Users/example/private/other".into(),
    ...
    fn discovery_truth_labels_and_redacts_private_refs() {
        ...
        db.upsert_provider_session_link(&ProviderSessionLink {
            ...
            cwd: Some("/Users/example/private/provider".into()),
