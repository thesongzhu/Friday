...
final class HomeViewModelTests: XCTestCase {
  ...
  func testLoadDetail_callsProviderDoctorReadArm() async throws {
    ...
    XCTAssertEqual(detail.providerReadiness?.keyValidations.map(\.provider), ["deepseek", "anthropic"])
    XCTAssertEqual(detail.providerReadiness?.keyValidations.first?.label, "valid")
    XCTAssertEqual(detail.providerReadiness?.keyValidations.first?.isConfirmedValid, true)
    XCTAssertEqual(detail.providerReadiness?.confirmedValidKeys, ["deepseek"])
    ...
    let proof: [String: Any] = [
      ...
      "actions": [
        ...
        [
          "surface": "mobile",
          "screen": "petEditor",
          "action_id": "mobile/pet/state-mapping",
          "capability_id": "mobile_pet_state_mapping_readiness",
          "status": "pass",
          "evidence_ref": "swift://mobile/pet/state-mapping/\(projection.missionId)",
          "source": "ios_home_projection_pet_state_mapping_runtime",
          "truth_label": "swift_viewmodel_read_projection_runtime_not_live_hub_not_sim_tap",
        ],
        [
          "surface": "mobile",
          "screen": "proofViewer",
          "action_id": "mobile/proof/viewer-open",
          "capability_id": "mobile_proof_viewer_receipt_readback",
          "status": "pass",
          "evidence_ref": "swift://mobile/proof/viewer-open/\(projection.missionId)",
          "source": "ios_home_projection_proof_viewer_runtime",
          "truth_label": "swift_viewmodel_read_projection_runtime_not_live_hub_not_sim_tap",
        ],
        [
          "surface": "mobile",
          "screen": "entrypoints",
          "action_id": "mobile/entrypoints/readiness",
          "capability_id": "mobile_entrypoints_readiness",
          "status": "pass",
          "evidence_ref": "swift://mobile/entrypoints/readiness/\(projection.missionId)",
          "source": "ios_home_projection_entrypoints_runtime",
          "truth_label": "swift_viewmodel_read_projection_runtime_not_live_hub_not_sim_tap",
        ],
      ],
      "caveat": "Partial runtime evidence only: iOS HomeProjection exposes mission/work-item refs, capability states, and selected-design readiness refs to native product destinations. This is not a live Hub mutation, not a simulator tap, not END-BAR, and not adoption.",
    ]
