    ...
    let payload: [String: Any] = [
      ...
      "actions": [
        [
          "surface": "mobile",
          "screen": "missions",
          "action_id": "mobile/missions/dispatch",
          "capability_id": "session_control_native_set",
          "status": "pass",
          "evidence_ref": "swift://mobile/missions/dispatch/mission-mobile-new-session-fixed",
          "proof": [
        ...
        [
          "surface": "mobile",
          "screen": "missions",
          "action_id": "mobile/missions/open-chat-loop",
          "capability_id": "session_control_native_set",
          "status": "pass",
          "evidence_ref": "swift://mobile/missions/open-chat-loop/mission-mobile-new-session-fixed",
          "proof": [
            "mission_id": "mission-mobile-new-session-fixed",
            "work_item_id": "work-mobile-new-session-fixed",
            "surface_thread_id": "surface-mobile-new-session-fixed",
