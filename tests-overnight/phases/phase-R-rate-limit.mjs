...
const POLICIES = [
  ...
  { id: "provider.write",        method: "POST", path: "/v1/providers", body: () => ({ kind:"openai", name:"rl-probe", baseUrl:"https://api.openai.com", api:"openai-responses", authMode:"bearer-token", apiKey:"sk-x", supportedModels:["x"], defaultModel:"x", validateOnSave:false }), max: 30, key: "principal", auth: true }, // pragma: allowlist secret
