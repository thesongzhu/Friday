...
export interface CreateFridaySystemUnixSocketBridgeOptions
...
function normalizeCompanionStatus(
  ...
  options: CreateFridaySystemUnixSocketBridgeOptions,
...
export function createFridaySystemUnixSocketBridge(
  options: CreateFridaySystemUnixSocketBridgeOptions,
): FridaySystemCompanionBridge {
  let connected = false;
