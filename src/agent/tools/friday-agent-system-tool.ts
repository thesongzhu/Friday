  ...
  return {
    ...
    parameters: {
      properties: {
        ...
        windowId: { type: "string", description: "Window identifier returned by a system snapshot." },
    ...
    async execute(
      ...
      try {
        ...
        const result = await systemService.executeIntent({
          ...
          targetKind: readStringParam(args, "targetKind") as "app" | "url" | "project" | "window" | undefined,
          appIdentifier: readStringParam(args, "appIdentifier"),
          windowId: readStringParam(args, "windowId"),
