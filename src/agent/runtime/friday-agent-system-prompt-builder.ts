...
export function buildFridayAgentSystemPrompt(
  ...
  return (
    ...
    "- Do not persist passwords, tokens, API keys, credentials, medical/financial/identity traits, or other sensitive/high-risk preferences with feedback or memory_store. Tell the user those require an explicit review or secure-storage flow instead.\n" +
