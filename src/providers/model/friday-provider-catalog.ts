...
export const FRIDAY_PROVIDER_PRESETS: Record<FridayProviderKind, FridayProviderPreset> = {
  ...
  openrouter: hostedPreset("openrouter", "openai-completions", "bearer-token", "https://openrouter.ai/api"),
  xai: hostedPreset("xai", "openai-completions", "bearer-token", "https://api.x.ai", "us"),
  mistral: hostedPreset("mistral", "openai-completions", "bearer-token", "https://api.mistral.ai"),
  groq: hostedPreset("groq", "openai-completions", "bearer-token", "https://api.groq.com/openai", "us"),
  ...
  moonshot: hostedPreset("moonshot", "openai-completions", "bearer-token", "https://api.moonshot.ai", "china"),
  "kimi-coding": hostedPreset("kimi-coding", "anthropic-messages", "api-key", "https://api.moonshot.ai/anthropic", "china"),
  qwen: hostedPreset("qwen", "openai-completions", "bearer-token", "https://dashscope.aliyuncs.com/compatible-mode", "china"),
