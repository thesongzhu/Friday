...
const files = {
  ...
  providerScreen: read(root, "apps/friday-ios/Sources/FridayMobileShell/FridayProviderAuthScreen.swift"),
  providerPanel: read(root, "apps/friday-ios/Sources/FridayMobileShell/ProviderReadinessPanel.swift"),
...
const checks = [
  ...
  {
    id: "ios-provider-workspace-home",
    target: "apps/friday-ios/Sources/FridayMobileShell/*Provider*",
    missing: missingStrings(files.providerScreen + files.providerPanel, [
      "Provider Workspace Home",
      "Route",
      "Cost & Evidence",
      "Open Ledger",
      "governed action gated",
      "never stored here",
      "confirmed keys",
      "keys probed",
    ]),
