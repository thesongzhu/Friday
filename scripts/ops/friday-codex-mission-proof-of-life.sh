...
INTAKE_BODY="$(jq -nc \
  ...
  '{
    ...
    missionId: $mission,
    workItemId: $work,
    title: "Reply FRIDAY_CODEX_PROOF_OK",
    intent: "Direct read-only verification run. No planning or clarification is needed; reply with exactly FRIDAY_CODEX_PROOF_OK.",
    lane: "codex",
