  ...
  phase5: createPhaseSteps([
    {
      ...
      args: [
        ...
        "test/integration/marketplace/friday-marketplace-install-failure-rollback.test.ts",
  ...
  marketplace: createPhaseSteps([
    { type: "npm", label: "Route contracts", script: "test:contracts:routes" },
    {
      ...
      args: [
        "vitest",
        "run",
        "test/unit/api/http/routes/friday-marketplace-asset-routes.test.ts",
        "test/unit/api/http/routes/friday-marketplace-creator-routes.test.ts",
        "test/unit/api/http/routes/friday-marketplace-request-routes.test.ts",
        "test/unit/marketplace/services/friday-marketplace-creator-service.test.ts",
        "test/unit/marketplace/services/friday-marketplace-request-board-service.test.ts",
        "test/unit/marketplace/engine/install-dispatcher.test.ts",
        "test/unit/marketplace/engine/listing-manager.test.ts",
        "test/unit/marketplace/engine/publisher-manager.test.ts",
        "test/unit/ui/marketplace-view-models.test.ts",
        "test/unit/ui/marketplace-click-path.test.ts",
        "test/unit/ui/assistant-marketplace-handoff.test.ts",
        "test/integration/marketplace/friday-marketplace-install-closure.test.ts",
        "test/integration/marketplace/friday-marketplace-install-failure-rollback.test.ts",
        "test/integration/marketplace/friday-marketplace-workflow-one-time-run-gate.test.ts",
      ],
    },
    { type: "npm", label: "Truth audit", script: "check:closeout:truth:marketplace" },
  ]),
};
