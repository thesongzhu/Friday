...
export function buildClosureScratchEnv(baseEnv = process.env, paths) {
  return {
    ...
    FRIDAY_ROUTE_PROVIDERS_VIA_RUST: baseEnv.FRIDAY_ROUTE_PROVIDERS_VIA_RUST ?? "1",
    FRIDAY_HUB_PROVIDERS_DETECT_BIN: baseEnv.FRIDAY_HUB_PROVIDERS_DETECT_BIN
      ?? path.join(paths.state, "bin", "hub_providers_detect"),
