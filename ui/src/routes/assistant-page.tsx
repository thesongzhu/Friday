...
const ASSISTANT_TASK_STORIES = [
  ...
  },
  {
    ...
    description: "Turn your goal into a workflow draft, then keep moving toward deploy without forcing builder jargon first.",
    outcome: "A deploy-ready workflow path with visible next steps.",
  },
  {
  ...
  },
  {
    ...
    title: "Guide me from a vague request",
    description: "Use a guided flow that narrows ambiguity into one concrete plan when you do not know the exact words or tooling yet.",
